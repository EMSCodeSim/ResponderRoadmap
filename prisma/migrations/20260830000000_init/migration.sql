...
CREATE TABLE "TaskBookTemplate" (
    ...
    "dueDateRule" TEXT,
    "intendedPosition" TEXT NOT NULL DEFAULT '',
    "templateKind" TEXT NOT NULL DEFAULT 'DEPARTMENT',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
...
CREATE TABLE "TaskBookRequirement" (
    ...
    "completionType" TEXT NOT NULL DEFAULT 'SKILL_DEMONSTRATION',
    "scoringMethod" TEXT NOT NULL DEFAULT 'PASS_FAIL',
    "evaluationStepsJson" TEXT NOT NULL DEFAULT '[]',
    "criticalFailuresJson" TEXT NOT NULL DEFAULT '[]',
    "evidenceTypesJson" TEXT NOT NULL DEFAULT '[]',
    "maxAttempts" INTEGER,
    "retryWaitHours" INTEGER,
    "remediationRequired" BOOLEAN NOT NULL DEFAULT false,
    "supervisorReviewOnFail" BOOLEAN NOT NULL DEFAULT false,
    "approvalPathJson" TEXT NOT NULL DEFAULT '["EVALUATOR"]',
    "standardsJson" TEXT NOT NULL DEFAULT '[]',
    "retryPolicy" TEXT NOT NULL DEFAULT 'UNLIMITED',
...
CREATE TABLE "SignOff" (
    ...
    "approvalLevel" TEXT NOT NULL DEFAULT 'EVALUATOR',
    "repetitionIndex" INTEGER NOT NULL DEFAULT 1,
    "attemptId" TEXT,
...
-- CreateIndex
CREATE INDEX "EvaluationAttempt_departmentId_completionId_idx" ON "EvaluationAttempt"("departmentId", "completionId");
...
-- AddForeignKey
ALTER TABLE "EvaluationAttempt" ADD CONSTRAINT "EvaluationAttempt_completionId_fkey" FOREIGN KEY ("completionId") REFERENCES "RequirementCompletion"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "EvaluationAttempt" ADD CONSTRAINT "EvaluationAttempt_evaluatorId_fkey" FOREIGN KEY ("evaluatorId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
