...
export default function FastStartPage() {
  ...
  return <div className="space-y-5">
    <PageHeader kicker="Task Books · guided start" title="Create a Task Book" description="Choose a starting point, create an editable draft, then review and publish before assigning members." actions={<Link href="/task-books/new"><Button variant="secondary">Advanced builder</Button></Link>} />
