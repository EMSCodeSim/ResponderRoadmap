...
export default function Page() {
  return <SeoProductPage
    ...
    secondTitle="Keep your existing RMS. Use Responder Roadmap for the qualification work."
    secondBody="Keep your existing RMS. Responder Roadmap manages the training workflow before the information reaches your official records system. It focuses on Task Books, individual Assignments, evaluations, approvals, and day-to-day qualification progress."
    related={[
